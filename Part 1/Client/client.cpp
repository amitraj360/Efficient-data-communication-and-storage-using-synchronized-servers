...
int dofiletransfering(string replydata, string destpath)
{
    ...
    writelog("******Connection  established for file transffering !!!");
...
int main(int argc, char const *argv[])
{
    ...
    cout<<"commands:\n1. share file_name meta_data_file_name.mtorrent\n2. get meta_data_file_name.mtorrent destination\n3. remove meta_data_file_name.mtorrent\n4. close.\n";
    if (argc != 5)
    {
